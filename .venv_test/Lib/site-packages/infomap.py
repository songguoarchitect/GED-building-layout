...
class Config(object):
    ...
    variableMarkovTime = property(
        _infomap.Config_variableMarkovTime_get,
        _infomap.Config_variableMarkovTime_set)
    variableMarkovTimeDamping = property(
        _infomap.Config_variableMarkovTimeDamping_get,
        _infomap.Config_variableMarkovTimeDamping_set)
    variableMarkovTimeMinLocalScale = property(
        _infomap.Config_variableMarkovTimeMinLocalScale_get,
        _infomap.Config_variableMarkovTimeMinLocalScale_set)
    markovTimeNoSelfLinks = property(
        _infomap.Config_markovTimeNoSelfLinks_get,
        _infomap.Config_markovTimeNoSelfLinks_set)
...
class Network(StateNetwork):
    ...
    def addMultilayerNode(self, layerId, physicalId, weight=1.0):
        return _infomap.Network_addMultilayerNode(
            self, layerId, physicalId, weight)
        ...
        if is_state_network:
            ...
            if is_multilayer_network:
                ...
                for _, d in g.nodes.data():
                    state_id = self.network.addMultilayerNode(
                        d[layer_id], d[phys_id])
